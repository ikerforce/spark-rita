...
El proceso \texttt{demoras\_ruta\_aeropuertos} tiene como operaciones principales las siguientes: la creación de una nueva llave a partir de la concatenación de dos columnas existentes, un conteo en una columna y cálculo del promedio en otras 5. Esto lo hace agrupando de acuerdo a la nueva llave y a otras columnas que describen periodos de tiempo. El resultado final se escribe a un archivo \texttt{parquet}.
