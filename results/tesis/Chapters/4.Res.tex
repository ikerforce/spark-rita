...
La gráfica \ref{lineas:local-demoras-ruta-mktid-write} muestra que el tiempo de escritura crece de una forma menos acelerada que el tiempo de ejecución total. Además, es interesante ver cómo en el caso de \textit{Spark} aproximadamente un 40\% del tiempo del tiempo total corresponde al tiempo de escritura. Por otro lado, debido a la falta de información sobre \textit{Dask}, no podemos obtener conclusiones concretas sobre la última ejecución y si tiempo de escritura a \textit{MySQL}. 
...
\end{axis}
\end{tikzpicture}
\caption{Duración promedio de la escritura de resultados del proceso demoras\_ruta\_aeropuerto en diferentes muestras.}
...
\begin{axis}[
  ...
  \addplot+[orange,mark options={fill=orange},error bars/.cd,y dir=both,y explicit] 
    table[x=x,y=y,y error=error] {
      ...
      10000 6.676 3.149
      100000 9.692 2.618
      1000000 56.797 8.323
      11000000 227.61 36.851
      % 80000000 NA NA
    };
  ...
  \addplot+[gray,mark options={fill=gray},error bars/.cd,y dir=both,y explicit] 
    table[x=x,y=y,y error=error] {
      ...
      1000000 500.644 822.738
      11000000 515.123 722.949
      % 80000000 NA NA
    };
    \legend {Dask, Spark}
\end{axis}
