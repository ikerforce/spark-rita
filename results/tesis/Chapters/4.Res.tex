...
\begin{axis}[
	xlabel = Número de registros procesados ($\text{log}_{10}$),
...
\begin{tikzpicture}[trim axis left, trim axis right]
\begin{axis}[
	xlabel = Número de registros escritos ($\text{log}_{10}$),
	ylabel = Duración en segundos,
	legend style={at={(0.45,0.95)}},
	xmode=log,
	log basis x={10},
