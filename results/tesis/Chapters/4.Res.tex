...
\end{tikzpicture}
\caption{Duración en segundos de los procesos con 10,000,000 de registros en el ambiente local.}
...
\begin{table}
    ...
    \end{tabular}}
    \caption{Información sobre tiempo de cómputo e inicio de la ejecución en segundos con muestra de 10 millones de registros en el ambiente local.}
...
\begin{table}
    ...
    \end{tabular}}
    \caption{Información sobre tiempo de escritura en segundos y tamaño del resultado con muestra de 10 millones de registros en el ambiente local.}
