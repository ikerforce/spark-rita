...
Los siguientes resultados fueron obtenidos ejecutando los procesos en el ambiente distribuido en la nube siguiendo la misma metodología. Los resultados y su análisis mantienen la misma estructura que la explicada en  \ref{chapter:resultados}.
...
\begin{tikzpicture}
  ...
  \end{axis}
\end{tikzpicture}
\caption{Duración de los procesos en el ambiente distribuido con 10,000 registros}
...
\begin{table}
    ...
    \end{tabular}}
    \caption{Información sobre la duración total en el ambiente distribuido con muestra de 10 mil registros.}
...
\begin{table}
    ...
    \end{tabular}}
    \caption{Información sobre tiempo de cómputo e inicio de la ejecución  en el ambiente distribuido con muestra de 10 mil registros.}
...
\begin{table}
    ...
    \end{tabular}}
    \caption{Información sobre la duración total en el ambiente distribuido con muestra de 100 mil registros.}
...
\begin{table}
    ...
    \end{tabular}}
    \caption{Información sobre tiempo de cómputo e inicio de la ejecución en el ambiente distribuido con muestra de 100 mil registros.}
...
\begin{table}
    ...
    \end{tabular}}
    \caption{Información sobre tiempo de escritura y tamaño del resultado en el ambiente distribuido con muestra de 100 mil registros.}
...
\begin{tikzpicture}
  ...
  \end{axis}
\end{tikzpicture}
\caption{Duración de los procesos en el ambiente distribuido con 1,000,000 de registros}
...
\begin{table}
    ...
    \hline
        ...
        dijkstra & dask & 58 & 56.035 & 8.411 & 0.15 & 0.113 & 8.827 \\ % \hline
        dijkstra & spark & 58 & 494.63 & 870.497 & 1.76 & 0.113 & 8.827 \\ % \hline
    ...
    \end{tabular}}
    \caption{Información sobre la duración total en el ambiente distribuido con muestra de 1 millón de registros.}
...
\begin{table}
    ...
    \hline
        ...
        dijkstra & dask & 1.117 & 55.823 & 8.796 & 0.114 \\ % \hline
        dijkstra & spark & 2.582 & 491.002 & 8.796 & 0.114 \\ % \hline
    ...
    \end{tabular}}
    \caption{Información sobre tiempo de cómputo e inicio de la ejecución en el ambiente distribuido con muestra de 1 millón de registros.}
...
\begin{table}
    ...
    \hline
        ...
        dijkstra & spark & mysql & 3.628 & Variable & Variable \\ % \hline
        dijkstra & dask & mysql & 0.212 & Variable & Variable \\ % \hline
        elimina\_nulos & spark & sin escritura & NA & NA & NA \\ % \hline
        elimina\_nulos & dask & sin escritura & NA & NA & NA \\ % \hline
        flota & spark & mysql & 6.223 & 76717 & 6 \\ % \hline
        flota & dask & mysql & 3.202 & 76717 & 6 \\ \hline
    \end{tabular}}
    \caption{Información sobre tiempo de escritura y tamaño del resultado en el ambiente distribuido con muestra de 1 millón de registros.}
...
\begin{table}
    ...
    \hline
        ...
        dijkstra & dask & 5 & 244.123 & 23.051 & 0.094 & 0.267 & 3.74 \\ % \hline
        dijkstra & spark & 4 & 913.103 & 514.234 & 0.563 & 0.267 & 3.74 \\ % \hline
    ...
    \end{tabular}}
    \caption{Información sobre la duración total en el ambiente distribuido con muestra de 10 millones de registros.}
...
\begin{table}
    ...
    \hline
        ...
        dijkstra & dask & 1.176 & 243.787 & 3.73 & 0.268 \\ % \hline
        dijkstra & spark & 2.919 & 909.363 & 3.73 & 0.268 \\ % \hline
    ...
    \end{tabular}}
    \caption{Información sobre tiempo de cómputo e inicio de la ejecución en el ambiente distribuido con muestra de 10 millones de registros.}
...
\begin{tikzpicture}
  ...
  \addplot[fill=gray] coordinates { (84.014,demoras\_aerolinea)
  						...
  						(245.573,demoras\_aeropuerto\_origen)
  						(290.496,demoras\_ruta\_aeropuerto)
  						(864.962,demoras\_ruta\_mktid)
  						(0,dijkstra)
  ...
  \addplot[fill=orange] coordinates { (61.23,demoras\_aerolinea)
  						...
  						(150.662,demoras\_aeropuerto\_origen)
  						(620.991,demoras\_ruta\_aeropuerto)
  						(0,dijkstra)
  ...
  \legend{Spark, Dask}
  \end{axis}
  \coordinate (A) at (1.85,4.6);
  \node at (A) {\textbf{\color{orange}{Error de memoria}}};
\end{tikzpicture}
\caption{Duración de los procesos en el ambiente distribuido con el total de registros}
...
\begin{table}
    ...
    \hline
        ...
        flota & spark & 90 & 40.662 & 1.601 & 0.039 & 0.303 & 3.305 \\ \hline
    \end{tabular}}
    \caption{Información sobre la duración total en el ambiente distribuido con el total de registros.}
...
\begin{table}
    ...
    \hline
        ...
        flota & spark & 2.521 & 34.439 & 3.783 & 0.264 \\ \hline
    \end{tabular}}
    \caption{Información sobre tiempo de cómputo e inicio de la ejecución en el ambiente distribuido con el total de registros.}
...
\begin{table}
    ...
    \hline
        ...
        flota & dask & mysql & 3.202 & 76717 & 6 \\ \hline
    \end{tabular}}
    \caption{Información sobre tiempo de escritura y tamaño del resultado en el ambiente distribuido con el total de registros.}
