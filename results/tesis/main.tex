...
% Contexto
\bibitem{seagate} Reinsel, D., Gantz, J., \&; Rydning, J. (2017, April). Data Age 2025: The Evolution of Data to Life-Critical . Don’t Focus on Big Data. \url{https://www.import.io/wp-content/uploads/2017/04/Seagate-WP-DataAge2025-March-2017.pdf}. 
...
% Dijkstra
\bibitem{dijkstraexplicado} Boardman, S. (2014). Shortest path problem (Dijkstra’s algorithm). In Advancing Maths For AQA: 2ndEdition (2nd ed., pp. 23–43). essay, Pearson. \url{www.pearsonschoolsandfecolleges.co.uk/secondary/Mathematics/16plus/AdvancingMathsForAQA2ndEdition/Samples/SampleMaterial/Chp-02\%20023-043.pdf}. 

\bibitem{dijkstrabellford} AbuSalim, S. W., Ibrahim, R., Saringat, M. Z., Jamel, S., \& Wahab, J. A. (2020, September). Comparative analysis between dijkstra and bellman-ford algorithms in shortest path optimization. In IOP Conference Series: Materials Science and Engineering (Vol. 917, No. 1, p. 012077). IOP Publishing. \url{https://iopscience.iop.org/article/10.1088/1757-899X/917/1/012077}

% Parquet
\bibitem{column-oriented} Abadi, D. J., Boncz, P. A., \& Harizopoulos, S. (2009). Column-oriented database systems. Proceedings of the VLDB Endowment, 2(2), 1664-1665. \url{https://paperhub.s3.amazonaws.com/741f4f9f3201baa76ddf05d3bff631bd.pdf}.
...
\bibitem{daskpaper} Rocklin, M. (2015, July). Dask: Parallel computation with blocked algorithms and task scheduling. In Proceedings of the 14th python in science conference (Vol. 130, p. 136). Austin, TX: SciPy. \url{https://pdfs.semanticscholar.org/73b5/8192f30bb6be8e798084d4481b97124570ed.pdf}.

\bibitem{daskoverheads} Böhm, S., \& Beránek, J. (2020, November). Runtime vs Scheduler: Analyzing Dask’s Overheads. In 2020 IEEE/ACM Workflows in Support of Large-Scale Science (WORKS) (pp. 1-8). IEEE. \url{https://arxiv.org/pdf/2010.11105.pdf}.
...
\bibitem{daskdistributedsetup} Anaconda Inc. (n.d.). Quickstart. Dask.distributed 2021.05.1 documentation. \url{https://distributed.dask.org/en/latest/quickstart.html#setup-dask-distributed-the-hard-way}. 
...
\bibitem{daskbestpractices} Anaconda Inc. (2018). Dask - Best Practices. Retrieved April 04, 2021, from \url{https://docs.dask.org/en/latest/dataframe-best-practices.html}.

% Spark
\bibitem{sparkberkeley} Zaharia, M., Xin, R. S., Wendell, P., Das, T., Armbrust, M., Dave, A., ... \& Stoica, I. (2016). Apache spark: a unified engine for big data processing. Communications of the ACM, 59(11), 56-65. Retrieved March 24, 2021, from \url{https://people.eecs.berkeley.edu/~alig/papers/spark-cacm.pdf}.
...
\bibitem{sparkconfcloudera} Ryza, S. (2015). How-to: Tune Your Apache Spark Jobs (Part 2). Cloudera Blog. \url{https://blog.cloudera.com/how-to-tune-your-apache-spark-jobs-part-2/}. 
...
\bibitem{sparkguide} Chambers, B., \& Zaharia, M. (2018). Spark: The definitive guide: Big data processing made simple. O'Reilly Media, Inc.
...
\bibitem{repo-dask} Dask. (2021). dask/dask. GitHub. \url{https://github.com/dask/dask}.

\bibitem{repo-spark} Apache, Spark. (2021). apache/spark. GitHub. \url{https://github.com/apache/spark}.

\bibitem{stackoverflow-stats} Stack Overflow. (2021). Stack Overflow Trends. Stack Overflow Insights - Developer Hiring, Marketing, and User Research. \url{https://insights.stackoverflow.com/trends?tags=dask\%2Cpyspark\%2Capache-spark}.   

% AWS
\bibitem{ec2-instances} Amazon Web Services Inc. (2021). Amazon EC2 Instance Types.  \url{https://aws.amazon.com/ec2/instance-types/}.

% Comparacion Spark - Dask
\bibitem{comparative-evolution} Mehta, P., Dorkenwald, S., Zhao, D., Kaftan, T., Cheung, A., Balazinska, M., ... \& AlSayyad, Y. (2016). Comparative evaluation of big-data systems on scientific image analytics workloads. arXiv preprint arXiv:1612.02485. \url{https://homes.cs.washington.edu/~magda/papers/mehta-vldb17.pdf}. 

\bibitem{dask-spark-neuroimaging} Dugré, M., Hayot-Sasson, V., \& Glatard, T. (2019, November). A performance comparison of dask and apache spark for data-intensive neuroimaging pipelines. In 2019 IEEE/ACM Workflows in Support of Large-Scale Science (WORKS) (pp. 40-49). IEEE. \url{https://arxiv.org/pdf/1907.13030.pdf}.
...
% Repo de git
\bibitem{repo-spark-rita} Olarra, I. (2021). Comparación de Dask y Spark. Spark - Rita. \url{https://github.com/ikerforce/spark-rita}.
